...
def main():
    ...
    name = st.text_input("write the first number")
    age = st.number_input("Write your name")
    weight = st.number_input("Write your weight")
    height = st.number_input("Write your height")

    result = BMIApp(name,age,weight,height)
    if st.button("Calculate BMI"):
        st.write(f"You, {name} are: {result }")

if "app" not in st.session_state:
    st.session_state.app = BMIApp()
